  ...
  <div class="row">
    <div class="col-md-6 mt-5 ">
      ...
      <form class="" action="login.php" method="post">
        ...
        <button type="submit" name="create" style="margin-left: 33%;" class="btn btn-lg btn-dark mt-3"><i class="fa fa-plus"></i> Create Account</button>
      </form>
    </div>
    <div class="col-md-6 mt-5">
      <h3>Login</h3>
      ...
      <form class="" action="login.php" method="post">
        ...
        <button type="submit" name="submit" style="margin-left: 33%;" class="btn btn-lg btn-dark mt-3"><i class="fa fa-check"></i> Login</button>
      </form>
    </div>
  </div>
</div>
